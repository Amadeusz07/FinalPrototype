...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float mouseRotationSpeed = 12f;
        ...
        public float limitX = 1000f; //x limit of maps
        public float limitY = 1000f; //z limit of map
        ...
        private void Update()
        {
            ...
            {
                keyboardMovementSpeed = 80f;
                screenEdgeMovementSpeed = 80f;
                Debug.Log("Speed Up");
            }
            if (Input.GetKeyUp("left shift"))
            {
                keyboardMovementSpeed = 25f;
                screenEdgeMovementSpeed = 25f;
